...
const FileUploader = () => {
  ...
  useEffect(() => {
    const setupTfjsBackend = async () => {
      await tf.setBackend('webgl'); // or 'wasm' if using WASM backend
      await tf.ready();
    };
  ...
  const uploadFile = (formData) => {
    ...
    xhr.open("POST", "https://gesturespython.couponcrazes.com/convert-ppt-to-images/", true);
      ...
      {imageLinks.length === 0 ? (
        <div className="file-container">
          ...
          <div className="file-wrapper">
            ...
            />
            <div
              className={`file-content ${isDragActive ? "file-input--active" : ""}`}
